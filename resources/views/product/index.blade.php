<x-app-layout>
    ...
    >
        ...
        >
            <a href="{{route('product.view',$product->slug)}}" class="block overflow-hidden aspect-w-2 aspect-h-2">
                <img
                    src="{{$product->image}}"
                    alt=""
                    class="rounded-lg hover:scale-105 hover:rotate-1 transition-transform object-cover w-full h-full "
                />
            </a>
            <div class="p-4">
                <h3 class="text-lg">
